...
J1_list = J1_lb + (J1_ub - J1_lb) * rand(num_samples, 1);
DM_list = DM_lb + (DM_ub - DM_lb) * rand(num_samples, 1);
K_list = K_lb + (K_ub - K_lb) * rand(num_samples, 1);
...
%     save(['CrI3_data/20221107/', sprintf('sample_%d.mat',i_sample)], '-struct', 'struct_saving');
end
